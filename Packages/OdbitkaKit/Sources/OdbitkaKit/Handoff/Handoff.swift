...
public enum OdbitkaConfig {
    public static let appGroupID = "group.pl.froncek.odbitka"
    public static let urlScheme = "odbitka"
...
public enum HandoffStore {
    ...
    public static var containerURL: URL? {
        FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: OdbitkaConfig.appGroupID)
    }
    ...
    public static func handoffURL(sessionID: String) -> URL? {
        URL(string: "\(OdbitkaConfig.urlScheme)://handoff?session=\(sessionID)")
    }

    public static func sessionID(from url: URL) -> String? {
        guard url.scheme == OdbitkaConfig.urlScheme,
              url.host == "handoff",
